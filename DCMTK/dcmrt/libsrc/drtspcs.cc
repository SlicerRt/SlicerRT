...
#include "dcmtk/dcmrt/drtspcs.h"


// --- item class ---

DRTScheduledProtocolCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTScheduledProtocolCodeSequence::Item::Item(const Item &copy)
...
DRTScheduledProtocolCodeSequence::Item::~Item()
{
}


DRTScheduledProtocolCodeSequence::Item &DRTScheduledProtocolCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTScheduledProtocolCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTScheduledProtocolCodeSequence::Item::isEmpty()
{
...
OFBool DRTScheduledProtocolCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTScheduledProtocolCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "ScheduledProtocolCodeSequence");
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "ScheduledProtocolCodeSequence");
        ProtocolContextSequence.read(item, "1-n", "3", "ScheduledProtocolCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTScheduledProtocolCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "ScheduledProtocolCodeSequence");
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "ScheduledProtocolCodeSequence");
        if (result.good()) result = ProtocolContextSequence.write(item, "1-n", "3", "ScheduledProtocolCodeSequence");
    }
    return result;
}


OFCondition DRTScheduledProtocolCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTScheduledProtocolCodeSequence::DRTScheduledProtocolCodeSequence(const DRTScheduledProtocolCodeSequence &copy)
...
DRTScheduledProtocolCodeSequence &DRTScheduledProtocolCodeSequence::operator=(const DRTScheduledProtocolCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTScheduledProtocolCodeSequence::~DRTScheduledProtocolCodeSequence()
{
    clear();
}


void DRTScheduledProtocolCodeSequence::clear()
{
...
OFBool DRTScheduledProtocolCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTScheduledProtocolCodeSequence::isValid() const
{
...
OFCondition DRTScheduledProtocolCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTScheduledProtocolCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTScheduledProtocolCodeSequence::Item &DRTScheduledProtocolCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTScheduledProtocolCodeSequence::Item &DRTScheduledProtocolCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTScheduledProtocolCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTScheduledProtocolCodeSequence::read(DcmItem &dataset,
                                                   const OFString &card,
                                                   const OFString &type,
                                                   const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_ScheduledProtocolCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_ScheduledProtocolCodeSequence);
...
OFCondition DRTScheduledProtocolCodeSequence::write(DcmItem &dataset,
                                                    const OFString &card,
                                                    const OFString &type,
                                                    const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_ScheduledProtocolCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
