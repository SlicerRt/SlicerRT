...
#include "dcmtk/dcmrt/drtdimcs.h"


// --- item class ---

DRTDeidentificationMethodCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTDeidentificationMethodCodeSequence::Item::Item(const Item &copy)
...
DRTDeidentificationMethodCodeSequence::Item::~Item()
{
}


DRTDeidentificationMethodCodeSequence::Item &DRTDeidentificationMethodCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTDeidentificationMethodCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTDeidentificationMethodCodeSequence::Item::isEmpty()
{
...
OFBool DRTDeidentificationMethodCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTDeidentificationMethodCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "DeidentificationMethodCodeSequence");
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "DeidentificationMethodCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "DeidentificationMethodCodeSequence");
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "DeidentificationMethodCodeSequence");
    }
    return result;
}


OFCondition DRTDeidentificationMethodCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTDeidentificationMethodCodeSequence::DRTDeidentificationMethodCodeSequence(const DRTDeidentificationMethodCodeSequence &copy)
...
DRTDeidentificationMethodCodeSequence &DRTDeidentificationMethodCodeSequence::operator=(const DRTDeidentificationMethodCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTDeidentificationMethodCodeSequence::~DRTDeidentificationMethodCodeSequence()
{
    clear();
}


void DRTDeidentificationMethodCodeSequence::clear()
{
...
OFBool DRTDeidentificationMethodCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTDeidentificationMethodCodeSequence::isValid() const
{
...
OFCondition DRTDeidentificationMethodCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTDeidentificationMethodCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTDeidentificationMethodCodeSequence::Item &DRTDeidentificationMethodCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTDeidentificationMethodCodeSequence::Item &DRTDeidentificationMethodCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTDeidentificationMethodCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTDeidentificationMethodCodeSequence::read(DcmItem &dataset,
                                                        const OFString &card,
                                                        const OFString &type,
                                                        const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_DeidentificationMethodCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_DeidentificationMethodCodeSequence);
...
OFCondition DRTDeidentificationMethodCodeSequence::write(DcmItem &dataset,
                                                         const OFString &card,
                                                         const OFString &type,
                                                         const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_DeidentificationMethodCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
