...
#include "dcmtk/dcmrt/drtadcs.h"


// --- item class ---

DRTAdmittingDiagnosesCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTAdmittingDiagnosesCodeSequence::Item::Item(const Item &copy)
...
DRTAdmittingDiagnosesCodeSequence::Item::~Item()
{
}


DRTAdmittingDiagnosesCodeSequence::Item &DRTAdmittingDiagnosesCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTAdmittingDiagnosesCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTAdmittingDiagnosesCodeSequence::Item::isEmpty()
{
...
OFBool DRTAdmittingDiagnosesCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTAdmittingDiagnosesCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "AdmittingDiagnosesCodeSequence");
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "AdmittingDiagnosesCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "AdmittingDiagnosesCodeSequence");
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "AdmittingDiagnosesCodeSequence");
    }
    return result;
}


OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTAdmittingDiagnosesCodeSequence::DRTAdmittingDiagnosesCodeSequence(const DRTAdmittingDiagnosesCodeSequence &copy)
...
DRTAdmittingDiagnosesCodeSequence &DRTAdmittingDiagnosesCodeSequence::operator=(const DRTAdmittingDiagnosesCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTAdmittingDiagnosesCodeSequence::~DRTAdmittingDiagnosesCodeSequence()
{
    clear();
}


void DRTAdmittingDiagnosesCodeSequence::clear()
{
...
OFBool DRTAdmittingDiagnosesCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTAdmittingDiagnosesCodeSequence::isValid() const
{
...
OFCondition DRTAdmittingDiagnosesCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTAdmittingDiagnosesCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTAdmittingDiagnosesCodeSequence::Item &DRTAdmittingDiagnosesCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTAdmittingDiagnosesCodeSequence::Item &DRTAdmittingDiagnosesCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTAdmittingDiagnosesCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTAdmittingDiagnosesCodeSequence::read(DcmItem &dataset,
                                                    const OFString &card,
                                                    const OFString &type,
                                                    const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_AdmittingDiagnosesCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_AdmittingDiagnosesCodeSequence);
...
OFCondition DRTAdmittingDiagnosesCodeSequence::write(DcmItem &dataset,
                                                     const OFString &card,
                                                     const OFString &type,
                                                     const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_AdmittingDiagnosesCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
