...
#include "dcmtk/dcmrt/drtrpcs.h"


// --- item class ---

DRTRequestedProcedureCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTRequestedProcedureCodeSequence::Item::Item(const Item &copy)
...
DRTRequestedProcedureCodeSequence::Item::~Item()
{
}


DRTRequestedProcedureCodeSequence::Item &DRTRequestedProcedureCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTRequestedProcedureCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTRequestedProcedureCodeSequence::Item::isEmpty()
{
...
OFBool DRTRequestedProcedureCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTRequestedProcedureCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "RequestedProcedureCodeSequence");
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "RequestedProcedureCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTRequestedProcedureCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "RequestedProcedureCodeSequence");
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "RequestedProcedureCodeSequence");
    }
    return result;
}


OFCondition DRTRequestedProcedureCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTRequestedProcedureCodeSequence::DRTRequestedProcedureCodeSequence(const DRTRequestedProcedureCodeSequence &copy)
...
DRTRequestedProcedureCodeSequence &DRTRequestedProcedureCodeSequence::operator=(const DRTRequestedProcedureCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTRequestedProcedureCodeSequence::~DRTRequestedProcedureCodeSequence()
{
    clear();
}


void DRTRequestedProcedureCodeSequence::clear()
{
...
OFBool DRTRequestedProcedureCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTRequestedProcedureCodeSequence::isValid() const
{
...
OFCondition DRTRequestedProcedureCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTRequestedProcedureCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTRequestedProcedureCodeSequence::Item &DRTRequestedProcedureCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTRequestedProcedureCodeSequence::Item &DRTRequestedProcedureCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTRequestedProcedureCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTRequestedProcedureCodeSequence::read(DcmItem &dataset,
                                                    const OFString &card,
                                                    const OFString &type,
                                                    const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_RequestedProcedureCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_RequestedProcedureCodeSequence);
...
OFCondition DRTRequestedProcedureCodeSequence::write(DcmItem &dataset,
                                                     const OFString &card,
                                                     const OFString &type,
                                                     const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_RequestedProcedureCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
