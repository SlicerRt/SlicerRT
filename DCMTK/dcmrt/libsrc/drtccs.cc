...
OFCondition DRTConceptCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "ConceptCodeSequence");
...
OFCondition DRTConceptCodeSequence::Item::write(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "ConceptCodeSequence");
