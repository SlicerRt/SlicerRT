...
#include "dcmtk/dcmrt/drtblds1.h"


// --- item class ---

DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::Item(const OFBool emptyDefaultItem)
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::Item(const Item &copy)
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::~Item()
{
}


DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item &DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::isEmpty()
{
...
OFBool DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::read(DcmItem &item)
{
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getLeafPositionBoundaries(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getLeafPositionBoundaries(Float64 &value, const unsigned long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getLeafPositionBoundaries(OFVector<Float64> &value) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getNumberOfLeafJawPairs(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getNumberOfLeafJawPairs(Sint32 &value, const unsigned long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getRTBeamLimitingDeviceType(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getSourceToBeamLimitingDeviceDistance(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::getSourceToBeamLimitingDeviceDistance(Float64 &value, const unsigned long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::setLeafPositionBoundaries(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = LeafPositionBoundaries.putString(value.c_str());
    }
    return result;
}


OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::setNumberOfLeafJawPairs(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = NumberOfLeafJawPairs.putString(value.c_str());
    }
    return result;
}


OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::setRTBeamLimitingDeviceType(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = RTBeamLimitingDeviceType.putString(value.c_str());
    }
    return result;
}


OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item::setSourceToBeamLimitingDeviceDistance(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = SourceToBeamLimitingDeviceDistance.putString(value.c_str());
    }
    return result;
}
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule::DRTBeamLimitingDeviceSequenceInRTBeamsModule(const OFBool emptyDefaultSequence)
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule::DRTBeamLimitingDeviceSequenceInRTBeamsModule(const DRTBeamLimitingDeviceSequenceInRTBeamsModule &copy)
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule &DRTBeamLimitingDeviceSequenceInRTBeamsModule::operator=(const DRTBeamLimitingDeviceSequenceInRTBeamsModule &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule::~DRTBeamLimitingDeviceSequenceInRTBeamsModule()
{
    clear();
}


void DRTBeamLimitingDeviceSequenceInRTBeamsModule::clear()
{
...
OFBool DRTBeamLimitingDeviceSequenceInRTBeamsModule::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTBeamLimitingDeviceSequenceInRTBeamsModule::isValid() const
{
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item &DRTBeamLimitingDeviceSequenceInRTBeamsModule::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTBeamLimitingDeviceSequenceInRTBeamsModule::Item &DRTBeamLimitingDeviceSequenceInRTBeamsModule::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::read(DcmItem &dataset,
                                                               const OFString &card,
                                                               const OFString &type,
...
OFCondition DRTBeamLimitingDeviceSequenceInRTBeamsModule::write(DcmItem &dataset,
                                                                const OFString &card,
                                                                const OFString &type,
                                                                const char *moduleName)
{
