...
#include "dcmtk/dcmrt/drtpscs.h"


// --- item class ---

DRTPatientSpeciesCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTPatientSpeciesCodeSequence::Item::Item(const Item &copy)
...
DRTPatientSpeciesCodeSequence::Item::~Item()
{
}


DRTPatientSpeciesCodeSequence::Item &DRTPatientSpeciesCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTPatientSpeciesCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTPatientSpeciesCodeSequence::Item::isEmpty()
{
...
OFBool DRTPatientSpeciesCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTPatientSpeciesCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "PatientSpeciesCodeSequence");
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "PatientSpeciesCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTPatientSpeciesCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "PatientSpeciesCodeSequence");
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "PatientSpeciesCodeSequence");
    }
    return result;
}


OFCondition DRTPatientSpeciesCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTPatientSpeciesCodeSequence::DRTPatientSpeciesCodeSequence(const DRTPatientSpeciesCodeSequence &copy)
...
DRTPatientSpeciesCodeSequence &DRTPatientSpeciesCodeSequence::operator=(const DRTPatientSpeciesCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTPatientSpeciesCodeSequence::~DRTPatientSpeciesCodeSequence()
{
    clear();
}


void DRTPatientSpeciesCodeSequence::clear()
{
...
OFBool DRTPatientSpeciesCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTPatientSpeciesCodeSequence::isValid() const
{
...
OFCondition DRTPatientSpeciesCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTPatientSpeciesCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTPatientSpeciesCodeSequence::Item &DRTPatientSpeciesCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTPatientSpeciesCodeSequence::Item &DRTPatientSpeciesCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTPatientSpeciesCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTPatientSpeciesCodeSequence::read(DcmItem &dataset,
                                                const OFString &card,
                                                const OFString &type,
                                                const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_PatientSpeciesCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_PatientSpeciesCodeSequence);
...
OFCondition DRTPatientSpeciesCodeSequence::write(DcmItem &dataset,
                                                 const OFString &card,
                                                 const OFString &type,
                                                 const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_PatientSpeciesCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
