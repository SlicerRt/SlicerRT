...
#include "dcmtk/dcmrt/drtrrpcs.h"      // for ReasonForRequestedProcedureCodeSequence
#include "dcmtk/dcmrt/drtrss.h"        // for ReferencedStudySequence
#include "dcmtk/dcmrt/drtrpcs.h"       // for RequestedProcedureCodeSequence
#include "dcmtk/dcmrt/drtspcs.h"       // for ScheduledProtocolCodeSequence


/** Interface class for RequestAttributesSequence (0040,0275)
 */
class DRTRequestAttributesSequence
  : protected DRTTypes
{
