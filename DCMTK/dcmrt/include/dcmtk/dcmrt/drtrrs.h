  ...
  : protected DRTTypes
{
  ...
  public:
      ...
      : protected DRTTypes
    {
      ...
      // --- get DICOM attribute values ---
         ...
         *  @return status, EC_Normal if successful, an error code otherwise
         */
        OFCondition getRTROIRelationship(OFString &value, const signed long pos = 0) const;
      ...
      // --- set DICOM attribute values ---
         ...
         *  @return status, EC_Normal if successful, an error code otherwise
         */
        OFCondition setRTROIRelationship(const OFString &value, const OFBool check = OFTrue);
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTRTRelatedROISequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTRTRelatedROISequence(const DRTRTRelatedROISequence &copy);

    /** destructor
     */
    virtual ~DRTRTRelatedROISequence();
