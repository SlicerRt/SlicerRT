...
/** Interface class for RelatedRTROIObservationsSequence (3006,00a0)
 */
class DRTRelatedRTROIObservationsSequence
  : protected DRTTypes
{
  ...
  public:
      ...
      : protected DRTTypes
    {
      ...
      private:
        ...
        /// ObservationNumber (3006,0082) vr=IS, vm=1, type=1C
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTRelatedRTROIObservationsSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTRelatedRTROIObservationsSequence(const DRTRelatedRTROIObservationsSequence &copy);

    /** destructor
     */
    virtual ~DRTRelatedRTROIObservationsSequence();
