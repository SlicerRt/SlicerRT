 ...
 *  File created on 2011-08-22 15:11:07 
 *
 */
...
#include "dcmtk/dcmrt/drttypes.h"      // helper class
#include "dcmtk/dcmrt/drtadcs.h"       // for AdmittingDiagnosesCodeSequence
#include "dcmtk/dcmrt/drtbrs.h"        // for BreedRegistrationSequence
#include "dcmtk/dcmrt/drtcdrs.h"       // for CalculatedDoseReferenceSequence
#include "dcmtk/dcmrt/drtcsis.h"       // for CodingSchemeIdentificationSequence
#include "dcmtk/dcmrt/drtces.h"        // for ContributingEquipmentSequence
#include "dcmtk/dcmrt/drtdimcs.h"      // for DeidentificationMethodCodeSequence
#include "dcmtk/dcmrt/drtdss.h"        // for DigitalSignaturesSequence
#include "dcmtk/dcmrt/drteas.h"        // for EncryptedAttributesSequence
#include "dcmtk/dcmrt/drtfgss.h"       // for FractionGroupSummarySequence
#include "dcmtk/dcmrt/drthsdrs.h"      // for HL7StructuredDocumentReferenceSequence
#include "dcmtk/dcmrt/drtmps.h"        // for MACParametersSequence
#include "dcmtk/dcmrt/drtmdrs.h"       // for MeasuredDoseReferenceSequence
#include "dcmtk/dcmrt/drtoas.h"        // for OriginalAttributesSequence
#include "dcmtk/dcmrt/drtopis.h"       // for OtherPatientIDsSequence
#include "dcmtk/dcmrt/drtpbcs.h"       // for PatientBreedCodeSequence
#include "dcmtk/dcmrt/drtpss.h"        // for PatientSetupSequence
#include "dcmtk/dcmrt/drtpscs.h"       // for PatientSpeciesCodeSequence
#include "dcmtk/dcmrt/drtppcs.h"       // for PerformedProtocolCodeSequence
#include "dcmtk/dcmrt/drtporis.h"      // for PhysiciansOfRecordIdentificationSequence
#include "dcmtk/dcmrt/drtprsis.h"      // for PhysiciansReadingStudyIdentificationSequence
#include "dcmtk/dcmrt/drtpcs.h"        // for ProcedureCodeSequence
#include "dcmtk/dcmrt/drtrps.h"        // for ReferencedPatientSequence
#include "dcmtk/dcmrt/drtrppss.h"      // for ReferencedPerformedProcedureStepSequence
#include "dcmtk/dcmrt/drtrrtps4.h"     // for ReferencedRTPlanSequence
#include "dcmtk/dcmrt/drtrss.h"        // for ReferencedStudySequence
#include "dcmtk/dcmrt/drtrtrs.h"       // for ReferencedTreatmentRecordSequence
#include "dcmtk/dcmrt/drtrpis.h"       // for ReferringPhysicianIdentificationSequence
#include "dcmtk/dcmrt/drtras.h"        // for RequestAttributesSequence
#include "dcmtk/dcmrt/drttms0.h"       // for TreatmentMachineSequence
#include "dcmtk/dcmrt/drttsibs.h"      // for TreatmentSessionIonBeamSequence
#include "dcmtk/dcmrt/drttscds.h"      // for TreatmentSummaryCalculatedDoseReferenceSequence
#include "dcmtk/dcmrt/drttsmds.h"      // for TreatmentSummaryMeasuredDoseReferenceSequence


/** Interface class for RTIonBeamsTreatmentRecordIOD
 */
class DRTIonBeamsTreatmentRecordIOD
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTIonBeamsTreatmentRecordIOD(const DRTIonBeamsTreatmentRecordIOD &copy);
  ...
  // --- get DICOM sequence attributes ---
     ...
     *  @return reference to sequence element
     */
    DRTReferencedTreatmentRecordSequence &getReferencedTreatmentRecordSequence()
  ...
  private:
    ...
    DRTReferencedTreatmentRecordSequence ReferencedTreatmentRecordSequence;
    ...
    // - also defined in: RTGeneralTreatmentRecordModule
    // DcmIntegerString InstanceNumber;
