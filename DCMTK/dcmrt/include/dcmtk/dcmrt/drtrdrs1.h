 ...
 */
class DRTReferencedDoseReferenceSequenceInRTBeamsModule
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedDoseReferenceSequenceInRTBeamsModule(const DRTReferencedDoseReferenceSequenceInRTBeamsModule &copy);
