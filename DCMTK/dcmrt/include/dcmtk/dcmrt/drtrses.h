...
#include "dcmtk/dcmrt/drtcis.h"        // for ContourImageSequence
  ...
  : protected DRTTypes
{
  ...
  public:
      ...
      : protected DRTTypes
    {
      ...
      private:
        ...
        /// ContourImageSequence (3006,0016) vr=SQ, vm=1, type=1C
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTRTReferencedSeriesSequence(const DRTRTReferencedSeriesSequence &copy);
