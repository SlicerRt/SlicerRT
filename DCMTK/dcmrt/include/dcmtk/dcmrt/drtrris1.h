 ...
 */
class DRTReferencedReferenceImageSequenceInRTBeamsModule
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedReferenceImageSequenceInRTBeamsModule(const DRTReferencedReferenceImageSequenceInRTBeamsModule &copy);
