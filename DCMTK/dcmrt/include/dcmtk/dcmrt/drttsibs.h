...
#include "dcmtk/dcmrt/drtas7.h"        // for ApplicatorSequence
#include "dcmtk/dcmrt/drtbldls.h"      // for BeamLimitingDeviceLeafPairsSequence
#include "dcmtk/dcmrt/drticpds.h"      // for IonControlPointDeliverySequence
#include "dcmtk/dcmrt/drtrbls.h"       // for RecordedBlockSequence
#include "dcmtk/dcmrt/drtrcos.h"       // for RecordedCompensatorSequence
#include "dcmtk/dcmrt/drtrlsds.h"      // for RecordedLateralSpreadingDeviceSequence
#include "dcmtk/dcmrt/drtrrms.h"       // for RecordedRangeModulatorSequence
#include "dcmtk/dcmrt/drtrrshs.h"      // for RecordedRangeShifterSequence
#include "dcmtk/dcmrt/drtrsns.h"       // for RecordedSnoutSequence
#include "dcmtk/dcmrt/drtrws.h"        // for RecordedWedgeSequence
#include "dcmtk/dcmrt/drtrbos7.h"      // for ReferencedBolusSequence
#include "dcmtk/dcmrt/drtrcdrs.h"      // for ReferencedCalculatedDoseReferenceSequence
#include "dcmtk/dcmrt/drtrmdrs.h"      // for ReferencedMeasuredDoseReferenceSequence
#include "dcmtk/dcmrt/drtrvis.h"       // for ReferencedVerificationImageSequence


/** Interface class for TreatmentSessionIonBeamSequence (3008,0021) in RTIonBeamsSessionRecordModule
 */
class DRTTreatmentSessionIonBeamSequence
  : protected DRTTypes
{
