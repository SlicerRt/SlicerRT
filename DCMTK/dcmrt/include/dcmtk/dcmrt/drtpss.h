...
#include "dcmtk/dcmrt/drtfds.h"        // for FixationDeviceSequence
#include "dcmtk/dcmrt/drtmss.h"        // for MotionSynchronizationSequence
#include "dcmtk/dcmrt/drtrsis.h"       // for ReferencedSetupImageSequence
#include "dcmtk/dcmrt/drtsds.h"        // for SetupDeviceSequence
#include "dcmtk/dcmrt/drtshds.h"       // for ShieldingDeviceSequence


/** Interface class for PatientSetupSequence (300a,0180)
 */
class DRTPatientSetupSequence
  : protected DRTTypes
{
