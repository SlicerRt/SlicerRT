...
public: \
  ...
  virtual vtkDataObject* ConstructRepresentationObjectByRepresentation(std::string representationName) { return NULL; }; \
  virtual vtkDataObject* ConstructRepresentationObjectByClass(std::string className) { return NULL; }; \
  virtual bool Convert(vtkDataObject* sourceRepresentation, vtkDataObject* targetRepresentation) { return true; } \
  virtual unsigned int GetConversionCost(vtkDataObject* sourceRepresentation=NULL, vtkDataObject* targetRepresentation=NULL) { return weight; }; \
