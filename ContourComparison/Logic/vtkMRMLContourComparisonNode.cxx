...
{
  this->SetNodeReferenceID(REFERENCE_CONTOUR_REFERENCE_ROLE, (node ? node->GetID() : NULL));
}
...
{
  this->SetNodeReferenceID(COMPARE_CONTOUR_REFERENCE_ROLE, (node ? node->GetID() : NULL));
}
