...
class PlmRegisterPlugin(RegistrationLib.RegistrationPlugin):
  ...
  def parameterStage1IsChanged(self):
    ...
    logging.info("Parameters value stage 1 changed")
    """
  ...
  def parameterStage2IsChanged(self):
    ...
    logging.info("Parameters value stage 2 changed")
  ...
  def parameterStage3IsChanged(self):
    ...
    logging.info("Parameters value stage 3 changed")
  ...
  def runOneIteration(self):
    ...
    logging.info("prealignment strategy is %s" % str(self.prealignmentComboBox.currentText))
    logging.info("subsampling is %s" % str(self.stage1_subsamplingLineEdit.text))
    ...
    #TODO: Set references, see right below but fix node variables
    #self.output_transform.AddNodeReferenceID(slicer.vtkMRMLTransformNode.GetMovingNodeReferenceRole(), movingVolumeNode.GetID())
    #self.output_transform.AddNodeReferenceID(slicer.vtkMRMLTransformNode.GetFixedNodeReferenceRole(), fixedVolumeNode.GetID())
