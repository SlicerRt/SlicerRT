...
//---------------------------------------------------------------------------
void vtkSlicerPlmProtonDoseEngineLogic::SetMRMLSceneInternal(vtkMRMLScene * newScene)
{
...
//-----------------------------------------------------------------------------
void vtkSlicerPlmProtonDoseEngineLogic::RegisterNodes()
{
  assert(this->GetMRMLScene() != 0);
}

//---------------------------------------------------------------------------
void vtkSlicerPlmProtonDoseEngineLogic::UpdateFromMRMLScene()
{
  assert(this->GetMRMLScene() != 0);
}
