...
public:
  ...
  explicit qSlicerPlmDrrModule(QObject *parent=0);
  virtual ~qSlicerPlmDrrModule();
...
protected:
  QScopedPointer<qSlicerPlmDrrModulePrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qSlicerPlmDrrModule);
  Q_DISABLE_COPY(qSlicerPlmDrrModule);
