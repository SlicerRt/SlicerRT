/*=========================================================================
  ...
  Module:    vtkSlicerRTScalarBarActor.cxx
...
vtkCxxSetObjectMacro(vtkSlicerRTScalarBarActor,LookupTable,vtkScalarsToColors);
vtkCxxSetObjectMacro(vtkSlicerRTScalarBarActor,LabelTextProperty,vtkTextProperty);
vtkCxxSetObjectMacro(vtkSlicerRTScalarBarActor,TitleTextProperty,vtkTextProperty);
vtkCxxSetObjectMacro(vtkSlicerRTScalarBarActor,BackgroundProperty,vtkProperty2D);
vtkCxxSetObjectMacro(vtkSlicerRTScalarBarActor,FrameProperty,vtkProperty2D);
...
void vtkSlicerRTScalarBarActor::ReleaseGraphicsResources(vtkWindow *win)
{
...
//----------------------------------------------------------------------------
int vtkSlicerRTScalarBarActor::RenderOverlay(vtkViewport *viewport)
{
...
//----------------------------------------------------------------------------
int vtkSlicerRTScalarBarActor::RenderOpaqueGeometry(vtkViewport *viewport)
{
  int renderedSomething = 0;
  int i;
  int size[2];
  ...
  if (positionsHaveChanged ||
    ...
    if ( this->Orientation == VTK_ORIENT_VERTICAL )
      ...
      for (i=0; i<numPts/2; i++)
        {
        x[0] = (this->TextPosition == vtkSlicerRTScalarBarActor::PrecedeScalarBar) 
      ...
      for (i=0; i<numPts/2; i++)
        {
        x[0] = barX + i*delta;
        x[1] = (this->TextPosition == vtkSlicerRTScalarBarActor::PrecedeScalarBar) 
    ...
    if (this->Orientation == VTK_ORIENT_VERTICAL)
      ...
      for (i=0; i < this->NumberOfLabels; i++)
        ...
        if (this->TextPosition == vtkSlicerRTScalarBarActor::PrecedeScalarBar)
          {
    ...
    if (this->Orientation == VTK_ORIENT_VERTICAL)
      {
      p1[0] = (this->TextPosition == vtkSlicerRTScalarBarActor::PrecedeScalarBar) 
        ? (size[0] - barWidth - barX) : barX;
      p1[1] = barY;
      p2[0] = p1[0] + barWidth;
      p2[1] = p1[1] + barHeight;
      ...
      {
      p1[0] = barX;
      p1[1] = (this->TextPosition == vtkSlicerRTScalarBarActor::PrecedeScalarBar) 
        ? (size[1] - barHeight - barY) : barY;
      p2[0] = p1[0] + barWidth;
      p2[1] = p1[1] + barHeight;
      }
...
int vtkSlicerRTScalarBarActor::HasTranslucentPolygonalGeometry()
{
  return 0;
}
...
//----------------------------------------------------------------------------
void vtkSlicerRTScalarBarActor::ShallowCopy(vtkProp *prop)
{
  vtkSlicerRTScalarBarActor *a = vtkSlicerRTScalarBarActor::SafeDownCast(prop);
  if ( a != NULL )
    {
...
//----------------------------------------------------------------------------
void vtkSlicerRTScalarBarActor::SizeTitle(int *titleSize, 
                                  int *size, 
                                  vtkViewport *viewport)
{
