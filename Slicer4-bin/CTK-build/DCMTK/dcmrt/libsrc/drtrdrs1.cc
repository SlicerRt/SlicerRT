...
#include "dcmtk/dcmrt/drtrdrs1.h"
...
DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::~Item()
{
}


DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item &DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::read(DcmItem &item)
{
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::getReferencedDoseReferenceNumber(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::getReferencedDoseReferenceNumber(Sint32 &value, const unsigned long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::setCumulativeDoseReferenceCoefficient(const OFString &value, const OFBool check)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = CumulativeDoseReferenceCoefficient.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item::setReferencedDoseReferenceNumber(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTReferencedDoseReferenceSequenceInRTBeamsModule::DRTReferencedDoseReferenceSequenceInRTBeamsModule(const OFBool emptyDefaultSequence)
...
DRTReferencedDoseReferenceSequenceInRTBeamsModule::~DRTReferencedDoseReferenceSequenceInRTBeamsModule()
{
    clear();
}


void DRTReferencedDoseReferenceSequenceInRTBeamsModule::clear()
{
...
OFBool DRTReferencedDoseReferenceSequenceInRTBeamsModule::isEmpty()
{
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item &DRTReferencedDoseReferenceSequenceInRTBeamsModule::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTReferencedDoseReferenceSequenceInRTBeamsModule::Item &DRTReferencedDoseReferenceSequenceInRTBeamsModule::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTReferencedDoseReferenceSequenceInRTBeamsModule::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
