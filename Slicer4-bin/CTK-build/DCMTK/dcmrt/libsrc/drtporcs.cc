...
#include "dcmtk/dcmrt/drtporcs.h"
...
OFCondition DRTPurposeOfReferenceCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "PurposeOfReferenceCodeSequence");
...
OFCondition DRTPurposeOfReferenceCodeSequence::Item::write(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "PurposeOfReferenceCodeSequence");
