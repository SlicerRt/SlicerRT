 ...
 *  Last modified on 2010-10-21 by Riesmeier
 *
 */
...
// conditions
const OFConditionConst ECC_InvalidValue      (OFM_dcmrt, 1, OF_error, "Invalid Value");
const OFConditionConst ECC_UnsupportedValue  (OFM_dcmrt, 2, OF_error, "Unsupported Value");
const OFConditionConst ECC_InvalidObject     (OFM_dcmrt, 3, OF_error, "Invalid Object");
// error code 4 is reserved for medium-level API error messages

const OFCondition RT_EC_InvalidValue         (ECC_InvalidValue);
const OFCondition RT_EC_UnsupportedValue     (ECC_UnsupportedValue);
const OFCondition RT_EC_InvalidObject        (ECC_InvalidObject);
