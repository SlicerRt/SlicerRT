...
#include "dcmtk/dcmrt/drtmucs.h"


// --- item class ---

DRTMeasurementUnitsCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTMeasurementUnitsCodeSequence::Item::Item(const Item &copy)
...
DRTMeasurementUnitsCodeSequence::Item::~Item()
{
}


DRTMeasurementUnitsCodeSequence::Item &DRTMeasurementUnitsCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTMeasurementUnitsCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTMeasurementUnitsCodeSequence::Item::isEmpty()
{
...
OFBool DRTMeasurementUnitsCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTMeasurementUnitsCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "MeasurementUnitsCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "MeasurementUnitsCodeSequence");
    }
    return result;
}


OFCondition DRTMeasurementUnitsCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTMeasurementUnitsCodeSequence::DRTMeasurementUnitsCodeSequence(const DRTMeasurementUnitsCodeSequence &copy)
...
DRTMeasurementUnitsCodeSequence &DRTMeasurementUnitsCodeSequence::operator=(const DRTMeasurementUnitsCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTMeasurementUnitsCodeSequence::~DRTMeasurementUnitsCodeSequence()
{
    clear();
}


void DRTMeasurementUnitsCodeSequence::clear()
{
...
OFBool DRTMeasurementUnitsCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTMeasurementUnitsCodeSequence::isValid() const
{
...
OFCondition DRTMeasurementUnitsCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTMeasurementUnitsCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTMeasurementUnitsCodeSequence::Item &DRTMeasurementUnitsCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTMeasurementUnitsCodeSequence::Item &DRTMeasurementUnitsCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTMeasurementUnitsCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTMeasurementUnitsCodeSequence::read(DcmItem &dataset,
                                                  const OFString &card,
                                                  const OFString &type,
                                                  const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_MeasurementUnitsCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_MeasurementUnitsCodeSequence);
...
OFCondition DRTMeasurementUnitsCodeSequence::write(DcmItem &dataset,
                                                   const OFString &card,
                                                   const OFString &type,
                                                   const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_MeasurementUnitsCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
