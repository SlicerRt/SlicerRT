...
#include "dcmtk/dcmrt/drtrrpcs.h"


// --- item class ---

DRTReasonForRequestedProcedureCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTReasonForRequestedProcedureCodeSequence::Item::Item(const Item &copy)
...
DRTReasonForRequestedProcedureCodeSequence::Item::~Item()
{
}


DRTReasonForRequestedProcedureCodeSequence::Item &DRTReasonForRequestedProcedureCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTReasonForRequestedProcedureCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTReasonForRequestedProcedureCodeSequence::Item::isEmpty()
{
...
OFBool DRTReasonForRequestedProcedureCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "ReasonForRequestedProcedureCodeSequence");
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "ReasonForRequestedProcedureCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "ReasonForRequestedProcedureCodeSequence");
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "ReasonForRequestedProcedureCodeSequence");
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setCodeMeaning(const OFString &value, const OFBool check)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = CodeMeaning.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = CodeValue.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        result = (check) ? DcmShortString::checkStringValue(value, "1") : EC_Normal;
        if (result.good())
            result = CodingSchemeDesignator.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        result = (check) ? DcmShortString::checkStringValue(value, "1") : EC_Normal;
        if (result.good())
            result = CodingSchemeVersion.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = ContextGroupExtensionCreatorUID.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = ContextGroupExtensionFlag.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        if (result.good())
            result = ContextGroupLocalVersion.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        result = (check) ? DcmDateTime::checkStringValue(value, "1") : EC_Normal;
        if (result.good())
            result = ContextGroupVersion.putString(value.c_str());
    }
    return result;
}


OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        result = (check) ? DcmCodeString::checkStringValue(value, "1") : EC_Normal;
        if (result.good())
            result = ContextIdentifier.putString(value.c_str());
    }
    return result;
}
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::Item::setMappingResource(const OFString &value, const OFBool check)
{
    ...
    if (!EmptyDefaultItem)
    {
        result = (check) ? DcmCodeString::checkStringValue(value, "1") : EC_Normal;
        if (result.good())
            result = MappingResource.putString(value.c_str());
    }
    return result;
}
...
DRTReasonForRequestedProcedureCodeSequence::DRTReasonForRequestedProcedureCodeSequence(const DRTReasonForRequestedProcedureCodeSequence &copy)
...
DRTReasonForRequestedProcedureCodeSequence &DRTReasonForRequestedProcedureCodeSequence::operator=(const DRTReasonForRequestedProcedureCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTReasonForRequestedProcedureCodeSequence::~DRTReasonForRequestedProcedureCodeSequence()
{
    clear();
}


void DRTReasonForRequestedProcedureCodeSequence::clear()
{
...
OFBool DRTReasonForRequestedProcedureCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTReasonForRequestedProcedureCodeSequence::isValid() const
{
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTReasonForRequestedProcedureCodeSequence::Item &DRTReasonForRequestedProcedureCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTReasonForRequestedProcedureCodeSequence::Item &DRTReasonForRequestedProcedureCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::read(DcmItem &dataset,
                                                             const OFString &card,
                                                             const OFString &type,
                                                             const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_ReasonForRequestedProcedureCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_ReasonForRequestedProcedureCodeSequence);
...
OFCondition DRTReasonForRequestedProcedureCodeSequence::write(DcmItem &dataset,
                                                              const OFString &card,
                                                              const OFString &type,
                                                              const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_ReasonForRequestedProcedureCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
