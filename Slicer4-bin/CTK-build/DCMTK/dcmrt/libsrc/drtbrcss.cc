...
#include "dcmtk/dcmrt/drtbrcss.h"
...
OFCondition DRTBreedRegistryCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, CodeMeaning, "1", "1C", "BreedRegistryCodeSequence");
...
OFCondition DRTBreedRegistryCodeSequence::Item::write(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmLongString(CodeMeaning), "1", "1C", "BreedRegistryCodeSequence");
