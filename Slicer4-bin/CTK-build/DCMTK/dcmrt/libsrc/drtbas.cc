...
#include "dcmtk/dcmrt/drtbas.h"


// --- item class ---

DRTContrastBolusAgentSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTContrastBolusAgentSequence::Item::Item(const Item &copy)
...
DRTContrastBolusAgentSequence::Item::~Item()
{
}


DRTContrastBolusAgentSequence::Item &DRTContrastBolusAgentSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTContrastBolusAgentSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTContrastBolusAgentSequence::Item::isEmpty()
{
...
OFBool DRTContrastBolusAgentSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTContrastBolusAgentSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "ContrastBolusAgentSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTContrastBolusAgentSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "ContrastBolusAgentSequence");
    }
    return result;
}


OFCondition DRTContrastBolusAgentSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTContrastBolusAgentSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTContrastBolusAgentSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTContrastBolusAgentSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTContrastBolusAgentSequence::DRTContrastBolusAgentSequence(const DRTContrastBolusAgentSequence &copy)
...
DRTContrastBolusAgentSequence &DRTContrastBolusAgentSequence::operator=(const DRTContrastBolusAgentSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTContrastBolusAgentSequence::~DRTContrastBolusAgentSequence()
{
    clear();
}


void DRTContrastBolusAgentSequence::clear()
{
...
OFBool DRTContrastBolusAgentSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTContrastBolusAgentSequence::isValid() const
{
...
OFCondition DRTContrastBolusAgentSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTContrastBolusAgentSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTContrastBolusAgentSequence::Item &DRTContrastBolusAgentSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTContrastBolusAgentSequence::Item &DRTContrastBolusAgentSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTContrastBolusAgentSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTContrastBolusAgentSequence::read(DcmItem &dataset,
                                                const OFString &card,
                                                const OFString &type,
                                                const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_ContrastBolusAgentSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_ContrastBolusAgentSequence);
...
OFCondition DRTContrastBolusAgentSequence::write(DcmItem &dataset,
                                                 const OFString &card,
                                                 const OFString &type,
                                                 const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_ContrastBolusAgentSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
