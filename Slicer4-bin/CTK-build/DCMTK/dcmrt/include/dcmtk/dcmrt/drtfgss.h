...
#include "dcmtk/dcmrt/drtfsss.h"       // for FractionStatusSummarySequence


/** Interface class for FractionGroupSummarySequence (3008,0220)
 */
class DRTFractionGroupSummarySequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTFractionGroupSummarySequence(const DRTFractionGroupSummarySequence &copy);
