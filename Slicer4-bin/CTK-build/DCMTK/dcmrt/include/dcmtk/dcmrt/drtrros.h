...
#include "dcmtk/dcmrt/drtrpps.h"       // for ROIPhysicalPropertiesSequence
#include "dcmtk/dcmrt/drtrics.h"       // for RTROIIdentificationCodeSequence
#include "dcmtk/dcmrt/drtrrs.h"        // for RTRelatedROISequence
#include "dcmtk/dcmrt/drtrrros.h"      // for RelatedRTROIObservationsSequence


/** Interface class for RTROIObservationsSequence (3006,0080)
 */
class DRTRTROIObservationsSequence
  : protected DRTTypes
{
