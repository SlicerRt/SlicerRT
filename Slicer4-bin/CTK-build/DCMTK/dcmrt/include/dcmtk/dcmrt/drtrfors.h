...
#include "dcmtk/dcmrt/drtforrs.h"      // for FrameOfReferenceRelationshipSequence
#include "dcmtk/dcmrt/drtrsts.h"       // for RTReferencedStudySequence


/** Interface class for ReferencedFrameOfReferenceSequence (3006,0010)
 */
class DRTReferencedFrameOfReferenceSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedFrameOfReferenceSequence(const DRTReferencedFrameOfReferenceSequence &copy);
