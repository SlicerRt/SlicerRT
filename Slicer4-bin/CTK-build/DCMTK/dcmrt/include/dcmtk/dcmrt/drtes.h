...
#include "dcmtk/dcmrt/drtas5.h"        // for ApplicatorSequence
#include "dcmtk/dcmrt/drtblds5.h"      // for BeamLimitingDeviceSequence
#include "dcmtk/dcmrt/drtbl5.h"        // for BlockSequence


/** Interface class for ExposureSequence (3002,0030) in RTImageModule
 */
class DRTExposureSequence
  : protected DRTTypes
{
