...
/** Interface class for ReferencedPerformedProcedureStepSequence (0008,1111)
 */
class DRTReferencedPerformedProcedureStepSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedPerformedProcedureStepSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTReferencedPerformedProcedureStepSequence(const DRTReferencedPerformedProcedureStepSequence &copy);

    /** destructor
     */
    virtual ~DRTReferencedPerformedProcedureStepSequence();
