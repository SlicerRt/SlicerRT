...
#include "dcmtk/dcmrt/drtbldps.h"      // for BeamLimitingDevicePositionSequence
#include "dcmtk/dcmrt/drtcpas.h"       // for CorrectedParameterSequence
#include "dcmtk/dcmrt/drtiwps.h"       // for IonWedgePositionSequence
#include "dcmtk/dcmrt/drtlsds7.h"      // for LateralSpreadingDeviceSettingsSequence
#include "dcmtk/dcmrt/drtos.h"         // for OverrideSequence
#include "dcmtk/dcmrt/drtrmss7.h"      // for RangeModulatorSettingsSequence
#include "dcmtk/dcmrt/drtrshs7.h"      // for RangeShifterSettingsSequence


/** Interface class for IonControlPointDeliverySequence (3008,0041) in RTIonBeamsSessionRecordModule
 */
class DRTIonControlPointDeliverySequence
  : protected DRTTypes
{
