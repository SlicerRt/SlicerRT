 ...
 */
class DRTWedgePositionSequence
  : protected DRTTypes
{
  ...
  public:
      ...
      : protected DRTTypes
    {
      ...
      private:
        ...
        /// ReferencedWedgeNumber (300c,00c0) vr=IS, vm=1, type=1C
        DcmIntegerString ReferencedWedgeNumber;
        /// WedgePosition (300a,0118) vr=CS, vm=1, type=1C
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTWedgePositionSequence(const DRTWedgePositionSequence &copy);
