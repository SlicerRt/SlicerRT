...
#include "dcmtk/dcmrt/drtmas.h"        // for ModifiedAttributesSequence


/** Interface class for OriginalAttributesSequence (0400,0561)
 */
class DRTOriginalAttributesSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTOriginalAttributesSequence(const DRTOriginalAttributesSequence &copy);
