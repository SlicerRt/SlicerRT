 ...
 */
class DRTBeamLimitingDeviceSequenceInRTBeamsModule
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTBeamLimitingDeviceSequenceInRTBeamsModule(const DRTBeamLimitingDeviceSequenceInRTBeamsModule &copy);
