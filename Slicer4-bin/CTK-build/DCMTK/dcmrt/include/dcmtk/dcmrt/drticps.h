...
#include "dcmtk/dcmrt/drtlsds6.h"      // for LateralSpreadingDeviceSettingsSequence
#include "dcmtk/dcmrt/drtrmss6.h"      // for RangeModulatorSettingsSequence
#include "dcmtk/dcmrt/drtrshs6.h"      // for RangeShifterSettingsSequence
#include "dcmtk/dcmrt/drtrdrs6.h"      // for ReferencedDoseReferenceSequence


/** Interface class for IonControlPointSequence (300a,03a8) in RTIonBeamsModule
 */
class DRTIonControlPointSequence
  : protected DRTTypes
{
