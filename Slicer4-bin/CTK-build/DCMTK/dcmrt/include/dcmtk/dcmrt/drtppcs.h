...
#include "dcmtk/dcmrt/drtpcxs.h"       // for ProtocolContextSequence


/** Interface class for PerformedProtocolCodeSequence (0040,0260)
 */
class DRTPerformedProtocolCodeSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTPerformedProtocolCodeSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTPerformedProtocolCodeSequence(const DRTPerformedProtocolCodeSequence &copy);

    /** destructor
     */
    virtual ~DRTPerformedProtocolCodeSequence();
