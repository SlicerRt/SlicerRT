...
#include "dcmtk/dcmrt/drtrbs2.h"       // for ReferencedBeamSequence
#include "dcmtk/dcmrt/drtrbas2.h"      // for ReferencedBrachyApplicationSetupSequence


/** Interface class for ReferencedFractionGroupSequence (300c,0020) in RTDoseModule
 */
class DRTReferencedFractionGroupSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedFractionGroupSequence(const DRTReferencedFractionGroupSequence &copy);
