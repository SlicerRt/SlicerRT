 ...
 */
class DRTTreatmentSummaryMeasuredDoseReferenceSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTTreatmentSummaryMeasuredDoseReferenceSequence(const DRTTreatmentSummaryMeasuredDoseReferenceSequence &copy);
