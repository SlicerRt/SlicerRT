...
#include "dcmtk/dcmrt/drtccs.h"        // for ConceptCodeSequence
#include "dcmtk/dcmrt/drtcncs.h"       // for ConceptNameCodeSequence
#include "dcmtk/dcmrt/drtcims.h"       // for ContentItemModifierSequence
#include "dcmtk/dcmrt/drtmucs.h"       // for MeasurementUnitsCodeSequence


/** Interface class for ProtocolContextSequence (0040,0440)
 */
class DRTProtocolContextSequence
  : protected DRTTypes
{
