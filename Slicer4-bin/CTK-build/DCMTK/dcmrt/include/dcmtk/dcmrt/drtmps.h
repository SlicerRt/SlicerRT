...
/** Interface class for MACParametersSequence (4ffe,0001)
 */
class DRTMACParametersSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTMACParametersSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTMACParametersSequence(const DRTMACParametersSequence &copy);

    /** destructor
     */
    virtual ~DRTMACParametersSequence();
