...
#include "dcmtk/dcmrt/drtcss.h"        // for ChannelSourceSequence


/** Interface class for MultiplexedAudioChannelsDescriptionCodeSequence (003a,0300)
 */
class DRTMultiplexedAudioChannelsDescriptionCodeSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTMultiplexedAudioChannelsDescriptionCodeSequence(const DRTMultiplexedAudioChannelsDescriptionCodeSequence &copy);
