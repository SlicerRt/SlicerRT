...
#include "dcmtk/dcmrt/drtas1.h"        // for ApplicatorSequence
#include "dcmtk/dcmrt/drtblds1.h"      // for BeamLimitingDeviceSequence
#include "dcmtk/dcmrt/drtbl2.h"        // for BlockSequence
#include "dcmtk/dcmrt/drtcos.h"        // for CompensatorSequence
#include "dcmtk/dcmrt/drtcps.h"        // for ControlPointSequence
#include "dcmtk/dcmrt/drtpvis.h"       // for PlannedVerificationImageSequence
#include "dcmtk/dcmrt/drtrbos1.h"      // for ReferencedBolusSequence
#include "dcmtk/dcmrt/drtrds.h"        // for ReferencedDoseSequence
#include "dcmtk/dcmrt/drtrris1.h"      // for ReferencedReferenceImageSequence
#include "dcmtk/dcmrt/drtws.h"         // for WedgeSequence


/** Interface class for BeamSequence (300a,00b0) in RTBeamsModule
 */
class DRTBeamSequence
  : protected DRTTypes
{
