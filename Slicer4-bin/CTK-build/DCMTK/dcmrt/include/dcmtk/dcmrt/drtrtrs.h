 ...
 *
 *  Header file for class DRTReferencedTreatmentRecordSequence
 *
...
/** Interface class for ReferencedTreatmentRecordSequence (3008,0030)
 */
class DRTReferencedTreatmentRecordSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedTreatmentRecordSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTReferencedTreatmentRecordSequence(const DRTReferencedTreatmentRecordSequence &copy);

    /** destructor
     */
    virtual ~DRTReferencedTreatmentRecordSequence();

    /** assigment operator
     *  @param copy sequence object to be copied
     */
    DRTReferencedTreatmentRecordSequence &operator=(const DRTReferencedTreatmentRecordSequence &copy);
