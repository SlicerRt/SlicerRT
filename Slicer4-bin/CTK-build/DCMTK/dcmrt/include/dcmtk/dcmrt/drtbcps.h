...
#include "dcmtk/dcmrt/drtbrdrs.h"      // for BrachyReferencedDoseReferenceSequence


/** Interface class for BrachyControlPointSequence (300a,02d0)
 */
class DRTBrachyControlPointSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTBrachyControlPointSequence(const DRTBrachyControlPointSequence &copy);
