...
/** Interface class for BeamLimitingDeviceLeafPairsSequence (3008,00a0)
 */
class DRTBeamLimitingDeviceLeafPairsSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTBeamLimitingDeviceLeafPairsSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTBeamLimitingDeviceLeafPairsSequence(const DRTBeamLimitingDeviceLeafPairsSequence &copy);

    /** destructor
     */
    virtual ~DRTBeamLimitingDeviceLeafPairsSequence();
