...
#include "dcmtk/dcmrt/drtbads.h"       // for BrachyAccessoryDeviceSequence
#include "dcmtk/dcmrt/drtchs.h"        // for ChannelSequence
#include "dcmtk/dcmrt/drtrris9.h"      // for ReferencedReferenceImageSequence


/** Interface class for ApplicationSetupSequence (300a,0230) in RTBrachyApplicationSetupsModule
 */
class DRTApplicationSetupSequence
  : protected DRTTypes
{
