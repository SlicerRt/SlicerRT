...
extern const OFCondition RT_EC_InvalidValue;

/// error: a value is not supported by this implementation
extern const OFCondition RT_EC_UnsupportedValue;

/// error: the object is invalid, see isValid() method in IOD class
extern const OFCondition RT_EC_InvalidObject;
...
extern OFLogger DCM_dcmrtLogger;
