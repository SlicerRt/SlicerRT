...
#include "dcmtk/dcmrt/drtics.h"        // for InstitutionCodeSequence
#include "dcmtk/dcmrt/drtpics.h"       // for PersonIdentificationCodeSequence


/** Interface class for PhysiciansReadingStudyIdentificationSequence (0008,1062)
 */
class DRTPhysiciansReadingStudyIdentificationSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTPhysiciansReadingStudyIdentificationSequence(const DRTPhysiciansReadingStudyIdentificationSequence &copy);
