 ...
 */
class DRTTreatmentSummaryCalculatedDoseReferenceSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTTreatmentSummaryCalculatedDoseReferenceSequence(const DRTTreatmentSummaryCalculatedDoseReferenceSequence &copy);
