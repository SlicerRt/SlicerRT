...
///   decimation step.
class VTK_SLICER_DICOMRTIMPORTEXPORT_CONVERSIONRULES_EXPORT vtkFractionalLabelmapToClosedSurfaceConversionRule
...
protected:
  void PadLabelmap(vtkOrientedImageData* FractionalLabelMap);
