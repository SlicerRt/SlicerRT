...
protected:
  ...
  /// Add the color of a contour to the corresponding color table (in the same structure set)
...
protected slots:
  /// Create structure set node under the current node
  void createChildStructureSetForCurrentNode();
